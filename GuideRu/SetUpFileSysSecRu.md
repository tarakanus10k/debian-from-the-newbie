...
Возвращаемся в "fstab" и согласно Debian 12 CIS Benchmark изменяем наш "/var":
...
Используем команду `mount | grep "/var"`, чтобы проверить, применились ли наши изменения:
