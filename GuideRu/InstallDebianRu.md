...
В пункте "sowtvare selection" выбираем "standart system utilities" (другого нам не дано:)). При вопросе "Install the GRUB loader?" отвечаем "yes" и на этом установка подходит к концу.
